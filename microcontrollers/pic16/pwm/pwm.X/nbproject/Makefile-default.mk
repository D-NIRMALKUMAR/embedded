...
SOURCEFILES_QUOTED_IF_SPACED=kanishka.c

# Object Files Quoted if spaced
OBJECTFILES_QUOTED_IF_SPACED=${OBJECTDIR}/kanishka.p1
POSSIBLE_DEPFILES=${OBJECTDIR}/kanishka.p1.d

# Object Files
OBJECTFILES=${OBJECTDIR}/kanishka.p1

# Source Files
SOURCEFILES=kanishka.c
...
ifeq ($(TYPE_IMAGE), DEBUG_RUN)
${OBJECTDIR}/kanishka.p1: kanishka.c  nbproject/Makefile-${CND_CONF}.mk 
	@${MKDIR} "${OBJECTDIR}" 
	${MP_CC} --pass1 kanishka.c $(MP_EXTRA_CC_PRE) -q --chip=$(MP_PROCESSOR_OPTION) -P  --outdir="${OBJECTDIR}" -N31 --warn=0 --runtime=default,+clear,+init,-keep,+osccal,-resetbits,-download,-stackcall,+clib --summary=default,-psect,-class,+mem,-hex --opt=default,+asm,-asmfile,-speed,+space,-debug,9 -D__DEBUG   --double=24 --float=24 --addrqual=ignore --mode=lite -g --asmlist "--errformat=%f:%l: error: (%n) %s" "--warnformat=%f:%l: warning: (%n) %s" "--msgformat=%f:%l: advisory: (%n) %s"
	@${MP_CC} --scandep  kanishka.c $(MP_EXTRA_CC_PRE) -q --chip=$(MP_PROCESSOR_OPTION) -P  --outdir="${OBJECTDIR}" -N31 --warn=0 --runtime=default,+clear,+init,-keep,+osccal,-resetbits,-download,-stackcall,+clib --opt=default,+asm,-asmfile,-speed,+space,-debug,9 -D__DEBUG   --double=24 --float=24 --addrqual=ignore --mode=lite -g --asmlist "--errformat=%f:%l: error: (%n) %s" "--warnformat=%f:%l: warning: (%n) %s" "--msgformat=%f:%l: advisory: (%n) %s"
	@echo ${OBJECTDIR}/kanishka.p1: > ${OBJECTDIR}/kanishka.p1.d
	@cat ${OBJECTDIR}/kanishka.dep >> ${OBJECTDIR}/kanishka.p1.d
	@${FIXDEPS} "${OBJECTDIR}/kanishka.p1.d" $(SILENT) -ht  -rsi ${MP_CC_DIR}../ 
